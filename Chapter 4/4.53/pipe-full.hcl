...
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IIADDQ, ILEAVE };
...
word d_srcA = [
	...
	D_icode in { IPOPQ, IRET, ILEAVE } : RRSP;
...
word d_srcB = [
	...
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET, ILEAVE } : RRSP;
	1 : RNONE;  # Don't need register
];
...
word aluA = [
	...
	E_icode in { IRET, IPOPQ, ILEAVE } : 8;
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ, IIADDQ, ILEAVE } : E_valB;
...
word mem_addr = [
	...
	M_icode in { ILEAVE } : M_valB;
	# Other instructions don't need address
];

## Set read control signal
bool mem_read = M_icode in { IMRMOVQ, IPOPQ, IRET, ILEAVE };
