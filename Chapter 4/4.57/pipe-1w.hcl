...
word f_icode = [
	# If the current instruction is popl and it's the second fetch, set icode to IPOP2
	f_pc == F_predPC && F_icode == IPOPL : IPOP2;
	# Otherwise, fetch the instruction as usual
	1: imem_icode;
];
